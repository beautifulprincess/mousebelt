...
class TssAdmin_General {
	public function echoPage() {
		...
		<form method="post" action="options.php">
						...
						<table class="form-table">
							<tr valign="top">
								...
								<td>
									...
									<p class="description">
										Optional. Type a name to easily identify this sidebar.
									</p>
								</td>
							</tr>
							<tr valign="top">
									...
									<p>
										<label>
											<input type="checkbox"
											       ...
											       checked>
											Try to automatically disable on responsive layouts (i.e. enable on desktop, disable on mobile/tablet).
										</label>
									</p>

									<p class="description">
										The plugin will be disabled if the specified container has a smaller or equal width than the sidebar.
									</p>
								</td>
							</tr>
						</table>
			...
			<button type="button" class="button add-another-sidebar tss-button-with-icon">
		...
		<script>
			(function ($) {
				...
				function renderSidebarRow(data) {
					...
					var showHideButton = '<button type="button" class="button button-show-hide tss-button-with-icon"><span class="dashicons dashicons-visibility"></span> <span class="span-show-hide">Show</span></button>';
					var tdButtons = $('<td class="tdButtons" style="text-align: center;">' + showHideButton + '<button type="button" class="button button-remove tss-button-with-icon"><span class="dashicons dashicons-trash"></span> Remove</button></td>');
					...
					// Show/hide buttons
					tr.find('.button-show-hide').on('click', function () {
                ...
                $('.add-another-sidebar').on("click", function () {
                    var tr = renderSidebarRow();
                    tr.find('.span-show-hide').text('Hide');
                });
