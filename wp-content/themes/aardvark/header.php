...
<div id="gp-global-wrapper"<?php if ( $header_display != 'gp-header-disabled' && ghostpool_option( 'side_menu_show_by_default' ) == 'enabled' ) { ?> class="gp-active-desktop-side-menu<?php if ( ghostpool_option( 'side_menu_show_by_default' ) == 'enabled' ) { ?> gp-side-menu-open-default<?php } ?>"<?php } ?>>
