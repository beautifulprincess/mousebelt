...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(
		...
		array(  
			...
			'title' => esc_html__( 'Frontend Redirect URL Exclusion', 'aardvark' ),
...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(								 
		...
		array(  
			...
			'title' => esc_html__( 'Open Side Menu By Default', 'aardvark' ),
			'type' => 'button_set',
			'options' => array(
				'enabled' => esc_html__( 'Enabled', 'aardvark' ),
				'disabled' => esc_html__( 'Disabled', 'aardvark' ),
			...
			'default' => 'enabled',
			'required' => array( 'header_layout', '=', array( 'gp-header-side-menu' ) ),
		),			
		...
		array(
			...
			'required' => array( 'fixed_header_type', '=', 'gp-fixed-scrolling-up-down' ),
		),
...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(
		...
		array(  
			...
			'subtitle' => esc_html__( 'This panel will only show if the author has added text to the "Biographical Info" field under Users > Your Profile.', 'aardvark' ),
			'type' => 'button_set',
			'options' => array(
				'enabled' => esc_html__( 'Enabled', 'aardvark' ),
				'disabled' => esc_html__( 'Disabled', 'aardvark' ),
...
Redux::setSection( $opt_name, array(
	...
	'fields'    => array(
		...
		array(
			...
			'type'      => 'typography',
			'title'     => esc_html__( 'Page Title Meta Typography', 'aardvark' ),
			'output'    => array( '#gp-page-title .gp-entry-meta', '#gp-page-title .gp-entry-meta a', '#gp-page-title #gp-breadcrumbs' ),
			'text-align' => false,
			'font-backup' => true,
			'text-transform' => true,
			'letter-spacing' => true,
...
Redux::setSection( $opt_name, array(
	...
	'fields'    => array(
		...
		array(
			...
			'output' => array(
				'.gp-loop-meta', '.gp-loop-meta a', '.gp-loop-tags a', '.widget .gp-loop-meta', '.widget .gp-loop-meta a', '.widget .gp-loop-tag a', '.gp-footer-widget .widget .gp-loop-meta', '.gp-footer-widget .widget .gp-loop-meta a', '.gp-footer-widget .widget .gp-loop-tag a', '.gp-comment-meta time', '.comment-reply-link', '#cancel-comment-reply-link', '.gp-loop-meta .sensei-course-meta > span', '.gp-loop-meta .lesson-meta > span', '.gp-loop-meta .sensei-free-lessons', '.gp-loop-meta .sensei-free-lessons a', '.woocommerce #reviews #comments ol.comment-list li .comment-text p.meta'
			),
			'text-align' => false,
			'font-backup' => true,
			'text-transform' => true,
