...
jQuery(function($){
    ...
    $.reduxMetaBoxes.init = function(){
        ...
        $('#inspector-select-control-1').change(function() {
            $.reduxMetaBoxes.checkBoxVisibility('inspector-select-control-1');
        });
    ...
    $('#publishing-action .button, #save-action .button, .components-button.editor-post-publish-button').click(function() {
