...
// Theme data
define( 'AARDVARK_THEME_VERSION', '2.7' );
...
if ( function_exists( 'vc_set_as_theme' ) ) {
	require_once( get_template_directory() . '/lib/framework/wpb-functions.php' );
}
 ...
 * @return bool
 */
/*REMOVEif ( ! function_exists( 'ghostpool_fs_put_contents' ) ) {
